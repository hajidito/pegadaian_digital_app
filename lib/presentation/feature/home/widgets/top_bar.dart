      ...
      child: Row(
        children: [
          SizedBox(
            ...
            child: CircleAvatar(
              radius: 30,
              backgroundImage: AssetImage("assets/images/png/profile_icon.png"),
            ),
          ),
              ...
              children: [
                RichText(
                  text: TextSpan(
                    text: 'Hi ',
                    style: TextStyle(
                        color: ColorsCustom.black, fontSize: 14, height: 1.5),
                    children: <TextSpan>[
                      TextSpan(
                          text: 'Sahabat!',
                ...
                Row(
                  ...
                  children: [
                    ...
                    Text(
                      '0 Poin',
                      style: TextStyle(
                          color: ColorsCustom.black, fontSize: 12, height: 1.5),
                    ),
                  ],
                )
              ],
